...
#endif
int
avmpack_is_valid(const void *avmpack_binary, uint32_t size)
{
...
int
avmpack_find_section_by_flag(const void *avmpack_binary,
                             uint32_t flags_mask,
                             const void **ptr,
                             uint32_t *size,
                             const char **name)
{
   ...
   do
   {
      const uint32_t *sizes = ((const uint32_t *) (avmpack_binary))
...
int
avmpack_find_section_by_name(const void *avmpack_binary,
                             const char *name,
                             const void **ptr,
                             uint32_t *size)
{
...
void *
avmpack_fold(void *accum, const void *avmpack_binary, avmpack_fold_fun fold_fun)
{
   int      offset = AVMPACK_SIZE;
   uint32_t size   = 0;
   ...
   do
   {
      const uint32_t *size_ptr = ((const uint32_t *) (avmpack_binary))
                                 + offset / sizeof (uint32_t);
